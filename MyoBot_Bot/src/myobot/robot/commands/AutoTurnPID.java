...
public class AutoTurnPID extends Command {
    ...
    protected void initialize() {
    	...
    	leftPID = new PIDController(kP, kI, kD, Robot.driveTrain.getLeftEncoder(), RobotMap.leftDrivePIDMotorUnramped);
    	rightPID = new PIDController(kP, kI, kD, Robot.driveTrain.getRightEncoder(), RobotMap.rightDrivePIDMotorUnramped);
